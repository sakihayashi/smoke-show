    ...
    return(
        <div className="ad-size">
            ...
            <div className="spec-wrapper" >
                ...
                <img alt="weight" src={weightIcon} style={{padding: '2px'}}   className="icon-s" loading="lazy" /><span className="spec-text">{' '}{video.carData.features.Measurements && video.carData.features.Measurements["Curb weight"]}</span><br />
